...
return [
    ...
    'bin' => [
    	'application/macbinary', 'application/mac-binary',
    ...
    'xls' => [
    	...
    	'application/x-xls', 'application/excel', 'application/download',
    ...
    'php' => [
    	'application/x-httpd-php', 'application/php', 'application/x-php',
    ...
    'zip' => [
    	...
    	'application/s-compressed', 'multipart/x-zip'
    ],
    'rar' =>    [
    ...
    'bmp' => [
    	...
    	'image/x-win-bitmap', 'image/x-windows-bmp', 'image/ms-bmp',
    	'image/x-ms-bmp', 'application/bmp', 'application/x-bmp',
    ...
    'xsl' => [
    	'application/xml', 'text/xsl', 'text/xml'
    ],
    'mpeg' => 'video/mpeg',
    'mpg' => 'video/mpeg',
    'mpe' => 'video/mpeg',
    ...
    'xlsx' => [
    	...
    	'application/zip', 'application/vnd.ms-excel', 'application/msword',
    	'application/x-zip'
    ],
    'word' => [
    ...
    'cdr' => [
    	'application/cdr', 'application/coreldraw', 'application/x-cdr',
    ...
    'jar' => [
    	'application/java-archive', 'application/x-java-application',
    	'application/x-jar', 'application/x-compressed'
    ],
    'svg' => [
